...
const WorkCard = () => {
  return (
    <div className="p-2 rounded-2xl bg-[#353839] flex-col m-6">
      <div className="flex gap-4 group">
        <img
          src={amazon}
          alt="logo"
          className="h-24 w-24 ml-8 mt-4 rounded-full transition group-hover:scale-[110%]"
        />
      ...
      <div className="mx-3 mb-2 bg-[#646262] rounded-2xl p-3 text-xs"> <b>SKILL: </b> 
